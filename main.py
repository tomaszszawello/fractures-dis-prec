...
while t < tmax and i < iters and not breakthrough:
    ...
    pressure, flow = Pr.find_flow(sid, apertures, lens, inc_matrix, mid_matrix, bound_matrix, in_matrix, pressure_b, in_edges)
    ...
    if i % sid.plot_every == 0:
        ...
        save_VTK(sid, G, apertures, fracture_lens, lens, flow, pressure, cb, name=f'network_{sid.old_iters:04d}.vtk')
        G = Pr.update_network(G, edge_list, apertures, flow)
