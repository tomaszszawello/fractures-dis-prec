...
while t < tmax and i < iters and not breakthrough:
    ...
    if i % sid.plot_every == 0:
        ...
        Dr.uniform_hist(sid, G, in_nodes, out_nodes, boundary_edges, cb, cc, vols, triangles_pos, name=f'network_{sid.old_iters:.2f}.png')

    # diams, dt = update_diameters(sid, flow, cb, diams, lens, inc_matrix, out_edges)
    diams, vols, dt, breakthrough = update_diameters_pi(sid, flow, cb, cc, diams, lens, inc_matrix, triangles_inc, vols, out_edges)
