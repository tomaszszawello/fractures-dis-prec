...
def build(sid:simInputData):
    ...
    if sid.load == 0:
        ...
        G, in_nodes, out_nodes, reg_nodes, boundary_nodes_out, boundary_nodes_in = set_geometry(sid.n, G, geo=sid.geo, R=sid.n//2.5, R_s=sid.n//20, in_nodes=sid.in_nodes_own, out_nodes=sid.out_nodes_own)
